package com.example.btldoan.config.jwt;
...
public class JwtUtils {
    ...
    public String getEmailFromJwtToken(String jwt) {
        ...
        log.info("Email claim: {}", claims);
        if (emailClaim != null) {
            return emailClaim.toString();
        } else {
            // Xử lý trường hợp không có trường email trong token
            throw new IllegalArgumentException("Token không chứa trường email");
        }
    }
